...
export type QuizQuestionType = 'multiple-choice' | 'fill-in-the-blank' | 'true-false' | 'reading'
...
export function createEmptyQuestion(type: QuizQuestionType, defaultTime = DEFAULT_TIME_LIMIT): QuizQuestion {
  const base = {
    id: generateId(),
    question: '',
